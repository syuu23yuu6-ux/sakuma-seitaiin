...
export const fallbackContent = {
  ...
  menus: [
    {
      ...
      isAccent: true,
      pricing: [
        { item: '施術料（一般）', price: '¥5,000', note: '目安時間: 約50分（初回は説明等含め約60分）' }
      ]
    },
    {
      id: 'balance-student',
      ...
      isAccent: false,
      pricing: [
        { item: '施術料（学生）', price: '¥4,500', note: '目安時間: 約50分（初回は説明等含め約60分）' }
      ]
    },
    {
      ...
      isAccent: false,
      pricing: [
        { item: '施術料（マタニティ）', price: '¥5,000', note: '目安時間: 約50分（初回は説明等含め約60分）' }
      ]
    },
    {
      id: 'refresh',
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'お客様おひとりのための広さ七坪程のプライベート整体院です。外の景色が見えて、明るい開放的な空間になっております！外からはベッドが見えないように、目隠しシールを貼っていますので、プライバシーは大丈夫です！ご自身だけのプライベート空間で、思わず寝てしまうような気持ち良い施術で、リラックスできる時間をお過ごし頂けます。'
    }
  ],
  news: [
    {
